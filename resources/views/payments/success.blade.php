      ...
      <div class="row h-100 justify-content-center align-items-center">
        <div class="mainbox col-sm ">
                  <div class="msg-heading">
                   ...
                   <div class="msg"><div class="error-notify-image"><img src="{{asset('/images/Paymentsuccess_fail-29.png')}}"></div>
                    <div class="msg-para">
                      <p>You have successfully completed your payment, thank you.</p>
                      <a href="javascript:void(0)" onclick="window.close()" id="contBtn">Go Home</a>
                    </div>
                  </div>
            </div>
      </div>  
